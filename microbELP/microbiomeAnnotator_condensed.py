                                ...
                                for z in range(len(data['documents'])):
                                    ...
                                    for i in range(len(data['documents'][z]['passages'])):
                                        for j in range(len(data['documents'][z]['passages'][i]['annotations'])):
                                            if data['documents'][z]['passages'][i]['annotations'][j]['text'] != data['documents'][z]['passages'][i]['text'][data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset']:data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset'] + data['documents'][z]['passages'][i]['annotations'][j]['locations']['length']]:
                                                                if '(' == data['documents'][z]['passages'][i]['text'][data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset']:data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset'] + data['documents'][z]['passages'][i]['annotations'][j]['locations']['length']][0] and data['documents'][z]['passages'][i]['text'][data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset']:data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset'] + data['documents'][z]['passages'][i]['annotations'][j]['locations']['length']].count(')') == 0:
                                                                    fix_para.append((z,i,j))
                                                                elif ', ' == data['documents'][z]['passages'][i]['text'][data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset']:data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset'] + data['documents'][z]['passages'][i]['annotations'][j]['locations']['length']][1:3] or '.,' == data['documents'][z]['passages'][i]['text'][data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset']:data['documents'][z]['passages'][i]['annotations'][j]['locations']['offset'] - data['documents'][z]['passages'][i]['offset'] + data['documents'][z]['passages'][i]['annotations'][j]['locations']['length']][1:3]:
                                                                    fix_aut.append((z,i,j))
                                                                else:
                                                                    other.append((z,i,j))
                                    for i in range(len(fix_para)):
                                        data['documents'][z]['passages'][fix_para[i][1]]['annotations'][fix_para[i][2]]['locations']['offset'] = data['documents'][z]['passages'][fix_para[i][1]]['annotations'][fix_para[i][2]]['locations']['offset'] + 1
                                    fix_aut = fix_aut[::-1]
                                    for i in range(len(fix_aut)):
                                        data['documents'][z]['passages'][fix_aut[i][1]]['annotations'].pop(fix_aut[i][2])
                                    for i in range(len(other)):
                                        if '(' in data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]:
                                            if ')' in data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]:
                                                if data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] == data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] + 2].replace('(', '').replace(')', ''):
                                                    # add an extra condition due to one having '(' at the 0th position and need to change the offset because of that 
                                                    if data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']][0] == '('and data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].count('(') > 1:
                                                        data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] + 2
                                                        data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] = data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] + 1
                                                    else:
                                                        data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] + 2
                                    for i in range(len(other)):
                                        if '(genu' in data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]:
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = len(data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].split(' (genu')[0])
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] = data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].split(' (genu')[0]
                                    for i in range(len(other)):
                                        if ', genu' in data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]:
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = len(data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].split(', genu')[0])
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] = data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].split(', genu')[0]
                                    for i in range(len(other)):
                                        if data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']][-1] == '.' or data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']][-1] == ',' or data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']][-1] == ' ':
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] - 1
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] = data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]
                                        elif data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']][-2:] == '. ' or data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']][-2:] == ', ':
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] - 2
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] = data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]
                                    for i in range(len(other)):
                                        if ') genu' in data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]:
                                            ...
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] = data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].split(') genu')[0]
                                    for i in range(len(other)):
                                        if '), gen' in data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]:
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = len(data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].split('), gen')[0])
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] = data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']].split('), gen')[0]
                                    for i in range(len(other)):
                                        if 'Escherichia. col' == data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]:
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] = data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length'] + 1
                                            data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['text'] = data['documents'][z]['passages'][other[i][1]]['text'][data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset']:data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['offset'] - data['documents'][z]['passages'][other[i][1]]['offset'] + data['documents'][z]['passages'][other[i][1]]['annotations'][other[i][2]]['locations']['length']]
                                    for i in range(len(other)):
