...
from src.master_positions_handler import ensure_parent_relationships, create_abundance_legend
...
def plot_study_dataset_on_tree(
    ...
    surface_text_size=10, abundance_threshold=None):
    ...
    if master_positions is None:
        ...
        from paste import generate_master_positions
...
def load_study_dataset(ncbi_taxonomy, df_ids):
    return create_filtered_rank_abundances_dict(ncbi_taxonomy, df_ids)