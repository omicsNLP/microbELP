...
def add_root_node(tax_parent_map, tax_children_map, tax_2_rank_string_map, tax_2_normalised_rank_value_map, filtered_rank_abundances_dict):
    """
...
def normalise_rank_hierarchy(rank_hierarchy, min_val=0, max_val=1):
...
def calculate_anchor_point(tax_id, tax_rank_map, tax_parent_map, tax_children_map, normalised_rank_hierarchy):
...
def create_filtered_rank_abundances_dict(ncbi_taxonomy, df_ids):
    ...
    normalised_rank_hierarchy = normalise_rank_hierarchy(rank_hierarchy)
    ...
    tax_parent_map, tax_children_map, tax_2_rank_string_map, tax_2_normalised_rank_value_map, filtered_rank_abundances_dict = add_root_node(
        tax_parent_map, tax_children_map, tax_2_rank_string_map, tax_2_normalised_rank_value_map, filtered_rank_abundances_dict
    )
    ...
    for tax_id in tax_2_rank_string_map:
        ...
        if rank in anchor_point_ranks and tax_id not in tax_2_normalised_rank_value_map:
            ...
            anchor_value, tax_parent_map, tax_children_map = calculate_anchor_point(
                tax_id, tax_2_rank_string_map, tax_parent_map, tax_children_map, normalised_rank_hierarchy
            )
...
def create_qvalue_dict(filtered_rank_abundances_dict, results_df):
